...
@include('sweetalert::alert')
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    ...
                    <div data-aos="fade-up" data-aos-delay="600" class="mt-4">
                ...
                <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
                    <img src="{{asset('ui/css/assets/img/hero.png')}}" class="img-fluid" alt="" style="max-height: 500px; width: auto;">
                </div>
            </div>
        </div>
    </section><!-- End Hero -->
    ...
    <main id="main">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="box text-center">
                            <img src="{{asset('ui/css/assets/img/receive.png')}}" class="img-fluid mb-3" alt="" style="max-height: 150px;">
                            <h3>Send Money</h3>
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
                        <div class="box text-center">
                            <img src="{{asset('ui/css/assets/img/loan.png')}}" class="img-fluid mb-3" alt="" style="max-height: 150px;">
                            <h3>Pay Bill</h3>
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
                        <div class="box text-center">
                            <img src="{{asset('ui/css/assets/img/send.png')}}" class="img-fluid mb-3" alt="" style="max-height: 150px;">
        ...
        <section>
            <div class="container">
                <div class="section-row row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        
                        <h3>Ready made checkout interfaces</h3>
                        <p class="mb-4">Easily generate your lightning invoice on our portal. Copy the invoice address or Scan the QRcode on our platform using any lighting mobile/web application.</p>
                        <p>Confirm payments and Receive the money or bills purchased instantly. This streamlined approach removes the complexity of converting Bitcoin into local currency yourself we handle it automatically.</p>
                    </div>
                    <div class="col-lg-6 col-md-12 d-flex justify-content-center">
                        <img src="{{asset('ui/css/assets/img/phone.png')}}" class="img-fluid" alt="" style="max-height: 400px;">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="container">
                <div class="section-row row align-items-center">
                    <div class="col-lg-6 col-md-12 d-flex justify-content-center order-lg-1 order-2">
                        <img src="{{asset('ui/css/assets/img/happy.jpg')}}" class="img-fluid" alt="" style="max-height: 400px; border-radius: 8px;">
                    </div>
                    <div class="col-lg-6 col-md-12 order-lg-2 order-1">
                        <h3 class="mb-4">Pay Your Bills</h3>
                        <p>
                            ...
                            our platform brings them all together in one convenient place.
                        </p>
                        <p class="mt-3">
        ...
        <section>
            <div class="container">
                <div class="section-row row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <h3 class="mb-4">Easy to integrate into your website or app</h3>
                        <p>We offer seamless bill payments with the {{env('APP_NAME')}} APIs. Add ZESCO, DStv, and more to your platform in minutes.</p>
                        <p class="mt-3">Whether you're running an e-commerce store, a fintech service, or a community platform
                            {{env('APP_NAME')}} empowers you to expand your payment options and attract customers who prefer using Bitcoin.</p>
                        <p class="mt-3">
                    ...
                    <div class="col-lg-6 col-md-12 d-flex justify-content-center">
                        <img src="{{asset('ui/css/assets/img/programmer.jpg')}}" class="img-fluid" alt="" style="max-height: 400px; border-radius: 8px;">
                    </div>
                </div>
            </div>
        </section>
